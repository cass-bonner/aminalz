...
let appSdkDir = path.join(__dirname,'..','..','app','src','services','aminalz-sdk');
...
function createSdk() {
  ...
  return new Promise((resolve, reject) => {
    ...
    let cmd = spawn('swagger-codegen', ['generate', '-i', swaggerDir + '/aminalz-exported.yml', '-l', 'typescript-angular2', '-o', apiSdkDir]);
