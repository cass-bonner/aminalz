...
import { Resource } from "../../services/aminalz-sdk/model/Resource";
...
import { CustomAuthorizerClient, IamAuthorizerClient } from "../../services/aminalz-api.service";
...
export class ResourceListPage {
  ...
  resourceAddPage = UploadResourcesPage;
  location = null;
  resources: Resource[] = [];
  ...
  gotoUploadResourcesPage(location) {
    let navParams = {
      "location": location,
    };
    this.navCtrl.push(UploadResourcesPage, navParams);
  }
