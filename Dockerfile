# Dockerfile for prodo, to make it easy to quickly try out the mobile app
#
# Build Docker image
# docker build -t prodo .

# Run Docker image
# docker run --rm -it -p 8100:8100 -p 35729:35729 prodo 
...
RUN git clone https://github.com/cass-bonner
RUN DIRPATH=$(pwd)/prodo
...
# change prompt color
RUN echo 'export PS1="\[\033[0;33m\][Docker container (prodo): \w]  \[\033[0m\]"' >> /root/.bashrc
